...
app.get("/api/nextweek", async (req, res) => {
  ...
  let url =
    ...
    "%2C" +
    lon +
    "&fields=temperatureMax&fields=temperatureMin&fields=weatherCode&fields=windSpeed&fields=sunsetTime&fields=pressureSeaLevel&fields=precipitationProbability&fields=sunriseTime&fields=humidity&fields=visibility&fields=cloudCover&fields=temperatureApparent&fields=uvIndex&fields=precipitationType&units=imperial&timesteps=1d&startTime=now&endTime=nowPlus4d&timezone=US%2FPacific&apikey=" +
